...
public class DialogChoosePicture extends Activity {//com.imagecaptured.DialogChoosePicture
...
//			findControls(cameraBtnId, galleryBtnId, cancelBtnId,videoGalaryBtnID);
			...
			setContentView(com.i_just_call_to_say.R.layout.change_picture_dialog_layout);
			//getWindow().setBackgroundDrawableResource(R.drawable.pic_chooser_bg);
